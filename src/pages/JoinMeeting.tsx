...
export default function JoinMeeting() {
  ...
  const appID = 489513716; // Your Zego Cloud App ID
  const serverSecret = "396f4bacb66282ffea0a5dbeb658bfd2"; // Your Zego Cloud server secret
        ...
        if (fetchedMeetings.docs.length) {
          ...
          if (meeting.meetingType === "1-on-1") {
            if (
              ...
              (meeting.invitedUsers[0] === user?.uid || isCreator)
            ) {
